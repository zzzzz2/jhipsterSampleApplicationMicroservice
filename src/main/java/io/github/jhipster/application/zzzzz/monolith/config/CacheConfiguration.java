...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterSampleApplicationMicroservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterSampleApplicationMicroservice");
        ...
        config.getMapConfigs().put("io.github.jhipster.application.zzzzz.monolith.domain.*", initializeDomainMapConfig(jHipsterProperties));
